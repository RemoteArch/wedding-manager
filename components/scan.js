...
const {
  detectQr,
  ensureJsQr
} = await loadModule("./modules/jjsqr.js");
const WelcomePanel = () => {
  const imageSrc = "./assets/images/scan/wedding-welcome.png";
  const imageAlt = "Bienvenue au mariage";
  return /*#__PURE__*/React.createElement("section", {
    className: "relative w-full md:w-1/2 h-screen flex flex-col  items-center justify-center"
    ...
    className: "w-full h-auto text-center relative z-20 mb-4"
  }, /*#__PURE__*/React.createElement("p", {
    className: "playfair-display text-[28px] text-gray-700 italic"
  }, "Bienvenue au mariage de"), /*#__PURE__*/React.createElement("p", {
    className: "playfair-display text-[42px] text-[#8B4513] font-bold"
  }, "Kristel & Frank")), /*#__PURE__*/React.createElement("img", {
    src: imageSrc,
    alt: imageAlt,
    className: "w-full h-auto object-contain relative z-0"
  }), /*#__PURE__*/React.createElement("div", {
    className: "absolute w-full h-[741px] -bottom-100 bg-white blur-[75px] pointer-events-none z-0"
  }));
};
...
const ScanPanel = () => {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "w-full min-h-screen bg-[#7A3B24] px-6 py-10 relative overflow-hidden"
  }, /*#__PURE__*/React.createElement("img", {
    ...
    className: "w-full max-w-[520px] mx-auto relative z-10 min-h-[calc(100vh-5rem)] flex flex-col justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-[22px] font-semibold leading-tight playfair-display"
  }, title), /*#__PURE__*/React.createElement("p", {
    className: "text-[16px] whitespace-pre-line opacity-95 leading-snug mt-1 eb-garamond"
  }, subtitle))), /*#__PURE__*/React.createElement("div", {
    className: "bg-black rounded-[22px] px-6 pt-10 pb-8 shadow-2xl flex flex-col"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-white text-center text-[30px] font-semibold leading-tight"
  }, scanTitle), /*#__PURE__*/React.createElement("div", {
    className: "flex-1 flex items-center justify-center"
  }, scanResult ? /*#__PURE__*/React.createElement("div", {
    className: "bg-white rounded-[22px] px-8 py-12 shadow-2xl text-center max-w-md w-full"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-[32px] font-bold mb-8 playfair-display italic underline"
  }, scanResult.status === 'scanned' ? "DÉJÀ SCANNÉ" : "ACCÈS AUTORISÉ !!"), /*#__PURE__*/React.createElement("p", {
    className: "text-[#8B0000] text-[36px] font-semibold mb-6 playfair-display"
  }, scanResult.nom), /*#__PURE__*/React.createElement("p", {
    className: "text-[#B8A07A] text-[24px] font-semibold playfair-display uppercase"
  }, "TABLE ", scanResult.table), scanResult.status === 'scanned' && /*#__PURE__*/React.createElement("p", {
    className: "text-[#FF6B6B] text-[18px] font-semibold mt-6 eb-garamond"
  }, "Cet invit\xE9 a d\xE9j\xE0 \xE9t\xE9 scann\xE9")) : accessDenied ? /*#__PURE__*/React.createElement("div", {
    className: "bg-white rounded-[22px] px-8 py-12 shadow-2xl text-center max-w-md w-full"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-[#8B0000] text-[32px] font-bold playfair-display italic underline"
  }, "ACC\xC8S NON AUTORIS\xC9")) : /*#__PURE__*/React.createElement(QrScannerBox, {
    onQrDetected: handleQrDetected
  }))), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-row items-center justify-center gap-5 text-white"
  }, /*#__PURE__*/React.createElement("div", {
    className: ""
  }, /*#__PURE__*/React.createElement("img", {
    src: adviceImageSrc,
    ...
    className: "text-[22px] font-semibold leading-tight playfair-display"
  }, adviceTitle), /*#__PURE__*/React.createElement("p", {
    className: "text-[16px] whitespace-pre-line opacity-95 leading-snug mt-1 eb-garamond"
  }, adviceText))))));
};
const QrScannerBox = ({
    ...
    const start = async () => {
      try {
        ...
        try {
          ...
          setVideoReady(false);
          throw new Error("Lecture vidéo bloquée. Autorise la caméra et vérifie que la page est en HTTPS (ou localhost).");
        }
        const loop = async () => {
          if (stopped) return;
        ...
        if (e?.name === "NotAllowedError" || e?.name === "PermissionDeniedError") {
          message = "Accès à la caméra refusé. Veuillez autoriser la caméra dans votre navigateur.";
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "mt-8 w-full aspect-square bg-[#6b6b6b] rounded-[14px] border border-white/70 overflow-hidden relative"
    ...
    ref: canvasRef,
    className: "hidden"
  }), !videoReady && !error && /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-0 flex items-center justify-center text-white/90 text-[14px] px-6 text-center"
  }, "Autorise l\u2019acc\xE8s \xE0 la cam\xE9ra pour afficher le flux."), !!result && /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute left-3 right-3 bottom-3 bg-red-600/80 text-white text-[14px] rounded px-3 py-2"
  }, error));
};
const style = () => {
...
const Main = () => {
  ...
  }, /*#__PURE__*/React.createElement(ScanPanel, null), /*#__PURE__*/React.createElement(WelcomePanel, null))));
};
export default Main;